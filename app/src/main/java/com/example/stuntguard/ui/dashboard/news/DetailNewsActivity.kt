...
import com.example.stuntguard.databinding.ActivityDetailNewsBinding
...
class DetailNewsActivity : AppCompatActivity() {
    ...
    private fun setupViewModel() {
        ...
        newsViewModel.getUserData().observe(this){user ->
            newsViewModel.getDetailNews(user.token, tokenNews as String)
        }
